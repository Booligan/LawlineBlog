...
const Navbar = () => {
    return (
        <nav className="navbar navbar-expand-sm navbar-dark bg-dark">
            <Link to="/" exact="true" className="navbar-brand"><img src="https://cdn.furthered.com/assets/ui/images/logos/lawline-rounded-light-horizontal-16-11-3.svg" width="100" /></Link>        
            ...
            <div className="collapse navbar-collapse" id="collapse-target">
                <ul className="navbar-nav ml-auto">
                    <li className="nav-item active">
                        <Link to="/posts/new" exact="true" className="nav-link" >Create A Post</Link>
                    </li>
                    <li className="nav-item">
                        <Link to="/" exact="true" className="nav-link" >Posts</Link>
                    </li>     
                    <li className="nav-item">
